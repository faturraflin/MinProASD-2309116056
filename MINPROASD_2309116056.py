...
class LinkedListBuku:
    ...
    def cari_buku(self, judul):
        ...
        # Mencari buku secara linear
        while current_node:
            if current_node.buku.nama == judul:
                print(f"Buku ditemukan pada indeks {index}. Informasi buku:")
                current_node.buku.display_info()
                found = True
                break
            current_node = current_node.next
...
while True:
    ...
    if pilihan == "1":
        ...
        judul_buku = input("Masukkan nama buku yang ingin dicari: ")
        perpustakaan1.daftar_buku.cari_buku(judul_buku)
    elif pilihan == "5":
